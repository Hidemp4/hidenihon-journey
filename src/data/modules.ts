...
export const MODULE_LIST: ModuleMeta[] = [
  {
    ...
    colorVar: "--hiragana",
    bgVar: "--hiragana-bg",
    gradient: "linear-gradient(135deg, hsl(200 80% 42%), hsl(200 70% 58%))",
  ...
  },
  {
    ...
    colorVar: "--katakana",
    bgVar: "--katakana-bg",
    gradient: "linear-gradient(135deg, hsl(280 60% 45%), hsl(280 50% 60%))",
  ...
  },
  {
    ...
    colorVar: "--kanji",
    bgVar: "--kanji-bg",
    gradient: "linear-gradient(135deg, hsl(15 85% 45%), hsl(15 75% 58%))",
